...
<!-- ![Image generated by FreePik](../assets/img/other/linear-regression-thumbnail.png) -->

<img src="../assets/img/other/lr-thumbnail.png" alt="Linear Regression Thumbnail" width="600px" height="900px" style="display: block; margin: auto;">
...
![lr03](../assets/img/other/lr-03.png)
...
![lr04](../assets/img/other/lr-04.png)
...
![lr05](../assets/img/other/lr-05.png)
...
![lr06](../assets/img/other/lr-06.png)

We can find the any distance `d` as

![lr07](../assets/img/other/lr-07.png)
![lr08](../assets/img/other/lr-08.png)

These distances are nothing but the errors, hence we can say

![lr09](../assets/img/other/lr-09.png)
...
![lr10](../assets/img/other/lr-10.png)

where `y actual` and `y predicted` are usually denoted as

![lr11](../assets/img/other/lr-11.png)
...
![lr12](../assets/img/other/lr-12.png)
...
![lr13](../assets/img/other/lr-13.png)
...
<img src="../assets/img/other/lr-end.png" alt="end" width="700px">